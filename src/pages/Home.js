...
const Home = () => {
  return (
    <div className="md:h-screen bg-[#2a201f] overflow-x-hidden pt-36 md:pt-0">
      <div className="md:flex w-full h-full items-center ">
        <div className="basis-5/12 text-center ">
          <div className="text-left md:w-3/4 mx-auto p-5 md:p-0">
            <h1 className="text-[#facf30] text-7xl md:text-8xl pb-8">HomeDez</h1>
            ...
            <p className="text-white text-lg pb-9">
              ...
              a dream home interior for over 300 families, lets do it for you!
            </p>
            <button className="py-4 text-xl px-9 rounded-xl bg-[#facf30] font-bold">
              Consult
            </button>
          </div>
        </div>
